    ...
    def __init__(
        ...
        *,
        ...
        self._java_obj = self._new_java_obj(
            "com.salmonbrain.ruleofthumb.CumulativeMetricTransformer", self.uid
        )
...
class WelchStatisticsTransformer(
    ...
    def __init__(
        ...
        *,
        ...
        self._java_obj = self._new_java_obj(
            "com.salmonbrain.ruleofthumb.WelchStatisticsTransformer", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class MannWhitneyStatisticsTransformer(
    ...
    def __init__(
        ...
        *,
        ...
        self._java_obj = self._new_java_obj(
            "com.salmonbrain.ruleofthumb.MannWhitneyStatisticsTransformer", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class AutoStatisticsTransformer(
    ...
    def __init__(
        ...
        *,
        ...
        self._java_obj = self._new_java_obj(
            "com.salmonbrain.ruleofthumb.AutoStatisticsTransformer", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class OutlierRemoveTransformer(
    ...
    def __init__(
        ...
        *,
        ...
        self._java_obj = self._new_java_obj(
            "com.salmonbrain.ruleofthumb.OutlierRemoveTransformer", self.uid
        )
